...
const STRINGS = {
  en: {
    ...
    'home.heroSub': "Describe your symptoms and we'll match you with the right specialist.",
    ...
    'chat.greeting': "Hi, I'm your health assistant 👋 Tell me what's bothering you: your symptoms and how long you've had them. I'll point you to the right specialty. I don't give medical advice or diagnoses.",
    ...
    'tour.replay': 'Show the app tour again',
    'tour.tapToContinue': 'Tap anywhere to continue',
    'tour.chatbot.title': 'Start with how you feel',
    'tour.chatbot.body': 'Describe your symptoms in your own words. The assistant works out which specialty fits and shows you the right doctors. It guides you, it never diagnoses.',
    'tour.doctors.title': 'Browse every doctor',
    'tour.doctors.body': 'The full list of specialists, with their ratings and the days they work.',
    'tour.search.title': 'Search by name or specialty',
    'tour.search.body': 'Type a name, or a specialty like cardiology, to jump straight to the right doctor.',
    'tour.map.title': 'See them on the map',
    'tour.map.body': 'Every hospital and clinic in the country, with the doctors who work at each one.',
    'tour.visits.title': 'Your appointments',
    'tour.visits.body': 'Upcoming visits and past ones. You can rate a doctor here after a visit.',
    'tour.emergency.title': 'Help in an emergency',
    'tour.emergency.body': 'This gives you the local emergency numbers and dials them for you. It works whether or not you are signed in.',
    'tour.profile.title': 'Your medical profile',
    'tour.profile.body': 'Add your allergies and long-term illnesses so any doctor treating you knows before the visit. Your prescriptions live here too.',
  },
  ...
  fr: {
    ...
    'home.heroSub': 'Décrivez vos symptômes et nous trouverons le bon spécialiste.',
    ...
    'chat.greeting': "Bonjour, je suis votre assistant santé 👋 Dites-moi ce qui vous gêne : vos symptômes et depuis quand. Je vous orienterai vers la bonne spécialité. Je ne donne ni conseils médicaux ni diagnostics.",
    ...
    'tour.tapToContinue': 'Touchez l\'écran pour continuer',
    'tour.chatbot.title': 'Commencez par ce que vous ressentez',
    'tour.chatbot.body': "Décrivez vos symptômes avec vos mots. L'assistant détermine la spécialité adaptée et vous montre les bons médecins. Il vous oriente, il ne diagnostique jamais.",
    'tour.doctors.title': 'Parcourez tous les médecins',
    'tour.doctors.body': 'La liste complète des spécialistes, avec leurs notes et leurs jours de consultation.',
    'tour.search.title': 'Cherchez par nom ou spécialité',
    'tour.search.body': 'Tapez un nom, ou une spécialité comme cardiologie, pour aller droit au bon médecin.',
    'tour.map.title': 'Voyez-les sur la carte',
    'tour.map.body': 'Tous les hôpitaux et cliniques du pays, avec les médecins qui y exercent.',
    'tour.visits.title': 'Vos rendez-vous',
    'tour.visits.body': 'Vos visites à venir et passées. Vous pouvez noter un médecin ici après la consultation.',
    'tour.emergency.title': "Aide en cas d'urgence",
    'tour.emergency.body': "Ce bouton affiche les numéros d'urgence locaux et les compose pour vous. Il fonctionne même sans être connecté.",
    'tour.profile.title': 'Votre profil médical',
    'tour.profile.body': 'Ajoutez vos allergies et maladies chroniques pour que tout médecin les connaisse avant la consultation. Vos ordonnances sont ici aussi.',
  },
  ...
  ar: {
    ...
    'tour.replay': 'إعادة عرض جولة التطبيق',
    'tour.tapToContinue': 'اضغط في أي مكان للمتابعة',
    'tour.chatbot.title': 'ابدأ بما تشعر به',
    'tour.chatbot.body': 'صِف أعراضك بكلماتك. يحدّد المساعد التخصص المناسب ويعرض لك الأطباء المناسبين. هو يرشدك ولا يشخّص أبداً.',
    'tour.doctors.title': 'تصفّح كل الأطباء',
    'tour.doctors.body': 'القائمة الكاملة للاختصاصيين، مع تقييماتهم وأيام عملهم.',
    'tour.search.title': 'ابحث بالاسم أو التخصص',
    'tour.search.body': 'اكتب اسماً أو تخصصاً مثل أمراض القلب للوصول مباشرة إلى الطبيب المناسب.',
    'tour.map.title': 'شاهدهم على الخريطة',
    'tour.map.body': 'كل المستشفيات والعيادات في البلد، مع الأطباء العاملين في كل منها.',
    'tour.visits.title': 'مواعيدك',
    'tour.visits.body': 'مواعيدك القادمة والسابقة. يمكنك تقييم الطبيب هنا بعد الزيارة.',
    'tour.emergency.title': 'المساعدة في الطوارئ',
    'tour.emergency.body': 'يعطيك هذا الزر أرقام الطوارئ المحلية ويتصل بها نيابةً عنك. يعمل سواء سجّلت الدخول أم لا.',
    'tour.profile.title': 'ملفك الطبي',
    'tour.profile.body': 'أضف حساسياتك وأمراضك المزمنة ليعرفها أي طبيب يعالجك قبل الزيارة. وصفاتك الطبية موجودة هنا أيضاً.',
  },
} as const
